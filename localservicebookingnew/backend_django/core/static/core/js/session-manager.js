...
class SessionManager {
    ...
    addProfileToNav(navElement) {
        ...
        // Build links based on user type
        const userType = this.currentUser.userType || 'customer';
        let dashboardLink = '';
        if (userType === 'provider') {
            dashboardLink = `<a href="/provider_dashboard.html" class="dropdown-item"><i class="fas fa-tachometer-alt"></i> Dashboard</a>`;
        } else if (userType === 'admin') {
            dashboardLink = `<a href="/admin_dashboard.html" class="dropdown-item"><i class="fas fa-shield-alt"></i> Admin Panel</a>`;
        }
